...
public class StatusBarUtil {
    ...
    private static Method CLEAREXTRAFLAGS;
    private static Method ADDEXTRAFLAGS;
    public static int EXTRA_FLAG_STATUS_BAR_DARK_MODE = 0x00000010;
    ...
    public static void setColor(Activity activity, @ColorInt int color) {
        setColor(activity, color, Build.MANUFACTURER.equals("Xiaomi") ? 0 : DEFAULT_STATUS_BAR_ALPHA);
    }
        ...
        try {
            if (darkmode) {
                if (ADDEXTRAFLAGS == null) {
                    ADDEXTRAFLAGS = window.getClass().getMethod("addExtraFlags", int.class);
                }
                ADDEXTRAFLAGS.invoke(window, EXTRA_FLAG_STATUS_BAR_DARK_MODE);
                ...
                if (CLEAREXTRAFLAGS == null) {
                    CLEAREXTRAFLAGS = window.getClass().getMethod("clearExtraFlags", int.class);
                }
                CLEAREXTRAFLAGS.invoke(window, EXTRA_FLAG_STATUS_BAR_DARK_MODE);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    View decorView = window.getDecorView();
                    int visibility = decorView.getSystemUiVisibility();
                    decorView.setSystemUiVisibility(visibility & ~View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
