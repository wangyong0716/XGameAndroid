...
import com.xgame.social.share.instance.DefaultShareInstance;
import com.xgame.social.share.instance.QQShareInstance;
import com.xgame.social.share.instance.ShareInstance;
import com.xgame.social.share.instance.WeiboShareInstance;
import com.xgame.social.share.instance.WxShareInstance;
...
public class ShareUtil {
    ...
    private static ShareInstance getShareInstance(@SharePlatform.Platform int platform,
        ...
        switch (platform) {
            ...
            case SharePlatform.WX_TIMELINE:
                return new WxShareInstance(context, SocialConstants.WX.APP_ID);
            case SharePlatform.QQ:
            case SharePlatform.QZONE:
                return new QQShareInstance(context, SocialConstants.QQ.APP_ID);
            case SharePlatform.WEIBO:
                return new WeiboShareInstance(context, SocialConstants.WB.APP_KEY);
    ...
    public static boolean isWeiXinInstalled(Context context) {
        IWXAPI api = WXAPIFactory.createWXAPI(context, SocialConstants.WX.APP_ID, true);
