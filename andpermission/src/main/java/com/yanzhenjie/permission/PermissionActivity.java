...
public final class PermissionActivity extends Activity {
    ...
    static final String KEY_CHECK_RATIONALE = "KEY_CHECK_RATIONALE";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        boolean checkRationale = intent.getBooleanExtra(KEY_CHECK_RATIONALE, true);
        ...
        if (sRationaleListener != null) {
            ...
            sRationaleListener.onRationaleResult(checkRationale ? rationale : false);
            sRationaleListener = null;
            finish();
            return;
        }
