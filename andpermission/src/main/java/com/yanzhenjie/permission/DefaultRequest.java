...
class DefaultRequest implements
    ...
    private boolean mCheckRationale = true;

    @Override
    public Request checkRationale(boolean check) {
        mCheckRationale = check;
        return this;
    }
    ...
    public void start() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (mDeniedPermissions.length > 0) {
                ...
                intent.putExtra(PermissionActivity.KEY_CHECK_RATIONALE, mCheckRationale);
